...
핵심 규칙 하나: PLAN.txt나 CLAUDE.md를 절대 git에 커밋하지 마십시오. 이들은 로컬 작업 문서이지 소스 코드가 아닙니다. PLAN.txt는 일시적인 세션 상태를 담고 있고, CLAUDE.md는 로컬 워크플로우에 맞게 조정된 지시를 담고 있습니다. 둘 다 레포지토리 히스토리에 노이즈가 되며, 개발 프로세스에 대한 정보를 유출할 수 있습니다.
